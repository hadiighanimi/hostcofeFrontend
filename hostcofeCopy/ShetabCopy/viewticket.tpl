...
{if !$invalidTicketId}
    <div class="card">
        <div class="card-body p-3">
            <h3 class="card-title">
                <i class="fa fa-quote-right"></i>{$subject}
        ...
        <div class="card-body">
            ...
            <form method="post" action="{$smarty.server.PHP_SELF}?tid={$tid}&amp;c={$c}&amp;postreply=true" enctype="multipart/form-data" role="form" id="frmReply">
                ...
                <div class="form-group">
                    ...
                    <button class="btn btn-info btn-sm" type="button" id="btnTicketAttachmentsAdd"><i class="fas fa-plus"></i></button><br><br>
                ...
                <div class="modal-footer">
                    <input class="btn btn-success" type="submit" name="save" value="{lang key='supportticketsticketsubmit'}" />
                    <input class="btn btn-danger" type="reset" value="{lang key='cancel'}" onclick="jQuery('#ticketReply').click()" />                </div>
            </form>
        </div>
