                    ...
                    {if $templatefile != 'homepage' && $templatefile != 'clientareahome' && $templatefile != 'clientregister' &&  $templatefile != 'viewticket' &&  $templatefile != 'supportticketslist'}
...
{if $loggedin}
    ...
    <div class="container">
        <p><span>کلیه حقوق برای </span><a target="_blank" href="https://whmcsco.com">این سایت</a> محفوظ می باشد. </p>
    </div>
    </footer>
    {/if}
{/if}
