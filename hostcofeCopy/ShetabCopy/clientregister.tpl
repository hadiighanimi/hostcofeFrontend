    ...
    <div id="registration">
        <form method="post" class="Registr100-form validate-form" action="{$smarty.server.PHP_SELF}" role="form" name="orderfrm" id="frmCheckout">
            ...
            <div id="containerNewUserSignup">
                ...
                <div class="login-boder" id="personalInformation">
            ...
            <div class="mb-4">
                <p class="text-muted mb-0  text-right">برای عضویت در رایانش ابری اهورا، لطفا فرم زیر با با دقت تکمیل بفرمایید</p>
                </hr>
            </div>
                        <div class="row">
                            <div class="col-sm-6">
...
{/if}
				<div class="login100-more" style="background-image: url('/templates/Shetab/whmcsco/img/login_back.jpg');">
				</div>
			</div>
		</div>
	</div>
