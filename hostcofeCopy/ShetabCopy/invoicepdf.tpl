...
$html = '<table dir="rtl" style="direction: rtl; width: 100%">
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left;">
                        <img src="https://crm.whmcsco.com/emza.jpg" style="width: 108px; height: 111px;" />
                    </td>
                </tr>
            <tbody>
        </table><hr/>';
...
$paymentToHtml = '<p style="text-align: right; direction: rtl; color:' . $titleColor . ';">'. $_LANG['invoicespayto'] .'</p>
                    <table style="width: 100%; font-size: 11px; line-height: 20px;">
                        <tbody>
                            <tr>
...
$invoiceItemsHtml = '<table width="100%" bgcolor="#efefef" cellspacing="1" cellpadding="2" border="0">
                        <tr height="30" bgcolor="#fafafa" style="font-weight:bold;text-align:center;">
                            <td width="20%" style="color:' . $titleColor . '; font-size: 11px; line-height: 30px;">' . Lang::trans('quotelinetotal') . '</td>
                            <td width="80%" style="text-align: center; color:' . $titleColor . ';font-size: 11px; line-height: 30px;">' . Lang::trans('invoicesdescription') . '</td>
                        </tr>';
...
$invoiceItemsHtml .= '
                    <tr height="30" bgcolor="#fafafa" style="font-weight:bold;">
                        <td align="center" style="font-size: 11px; line-height: 30px;">
...
if ($taxname) {
        $invoiceItemsHtml .= '
                            <tr height="30" bgcolor="#fafafa" style="font-weight:bold;">
                                <td align="center" style="font-size: 11px; line-height: 30px;">' . $tax . '</td>
...
if ($taxname2) {
    $invoiceItemsHtml .= '
                        <tr height="30" bgcolor="#fafafa" style="font-weight:bold;">
                            <td align="center" style="font-size: 11px; line-height: 30px;">' . $tax2 . '</td>
...
$invoiceTransactionsHtml = '<table width="100%" bgcolor="#efefef" cellspacing="1" cellpadding="2" border="0">
    <tr height="30" bgcolor="#fafafa" style="font-weight:bold;text-align:center;">
        <td width="20%" style="font-size: 11px; line-height: 30px; color:' . $titleColor . ';">' . Lang::trans('invoicestransamount') . '</td>
        <td width="30%" style="font-size: 11px; line-height: 30px; color:' . $titleColor . ';">' . Lang::trans('invoicestransid') . '</td>
        <td width="25%" style="font-size: 11px; line-height: 30px; color:' . $titleColor . ';">' . Lang::trans('invoicestransgateway') . '</td>
        <td width="25%" style="font-size: 11px; line-height: 30px; color:' . $titleColor . ';">' . Lang::trans('invoicestransdate') . '</td>
    </tr>';
...
if (!count($transactions)) {
    ...
    foreach ($transactions AS $trans) {
        ...
        <tr bgcolor="#fff">
            ...
            <td align="center" style="font-size: 11px; line-height: 30px;">' . $trans['transid'] . '</td>
            <td align="center" style="font-size: 11px; line-height: 30px;">' . $trans['gateway'] . '</td>
            <td align="center" style="font-size: 11px; line-height: 30px;">' . $trans['date'] . '</td>
        </tr>';
    }
}
